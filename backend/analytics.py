...
CATEGORY_MAP = {
    "Broad Market": ["NIFTY 50", "NIFTY NEXT 50", "NIFTY MIDCAP 150", "NIFTY SMLCAP 250", "NIFTY MICROCAP250", "NIFTY 500"],
    ...
    "Sectoral Indices": [
        "NIFTY AUTO", "NIFTY BANK", "NIFTY CEMENT", "NIFTY CHEMICALS", "NIFTY CONSUMER DURABLES", 
        "NIFTY FINANCIAL SERVICES", "NIFTY FINANCIAL SERVICES 25/50", "NIFTY FINANCIAL SERVICES EX-BANK", 
        "NIFTY FMCG", "NIFTY HEALTHCARE", "NIFTY IT", "NIFTY MEDIA", "NIFTY METAL", 
        "NIFTY MIDSMALL FINANCIAL SERVICES", "NIFTY MIDSMALL HEALTHCARE", "NIFTY MIDSMALL IT & TELECOM", 
        "NIFTY OIL & GAS", "NIFTY PHARMA", "NIFTY PRIVATE BANK", "NIFTY PSU BANK", 
        "NIFTY REALTY", "NIFTY500 HEALTHCARE"
    ],
    "Thematic Indices": [
        "NIFTY CAPITAL MARKETS", "NIFTY COMMODITIES", "NIFTY CONGLOMERATE 50", "NIFTY CORE HOUSING", 
        "NIFTY CPSE", "NIFTY ENERGY", "NIFTY EV & NEW AGE AUTOMOTIVE", "NIFTY HOUSING", 
        ...
        "NIFTY INDIA DIGITAL", "NIFTY INDIA INFRASTRUCTURE & LOGISTICS", "NIFTY INDIA INTERNET", 
        "NIFTY INDIA MFG", "NIFTY INDIA NEW AGE CONSUMPTION", "NIFTY INDIA RAILWAYS PSU", 
        "NIFTY CORP MAATR", "NIFTY INDIA TOURISM", "NIFTY INFRASTRUCTURE", "NIFTY IPO", 
        "NIFTY MIDCAP LIQUID 15", "NIFTY MIDSMALL INDIA CONSUMPTION", "NIFTY MNC", "NIFTY MOBILITY", 
        "NIFTY NON-CYCLICAL CONSUMER", "NIFTY PSE", "NIFTY REITS & INVITS", "NIFTY RURAL", 
        "NIFTY SERVICES SECTOR", "NIFTY SHARIAH 25", "NIFTY SME EMERGE", "NIFTY TRANSPORTATION & LOGISTICS", 
        "NIFTY WAVES", "NIFTY100 ENHANCED ESG", "NIFTY100 ESG", "NIFTY100 ESG SECTOR LEADERS", 
        "NIFTY100 LIQUID 15", "NIFTY50 SHARIAH", "NIFTY500 MULTICAP INDIA MANUFACTURING 50:30:20", 
